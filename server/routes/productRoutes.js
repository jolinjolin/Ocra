...
import { getProducts, getProductById, deleteProduct, addProduct, editProduct, addReview, getRecommendedProducts } from '../controllers/productController.js'
...
router.route('/recommend').get(getRecommendedProducts)//get recommended products
